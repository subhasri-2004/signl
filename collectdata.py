...
while True:
    _,frame=cap.read()
    count = {
             'a': len(os.listdir("MP_Data/A")),
             'b': len(os.listdir("MP_Data/B")),
             'c': len(os.listdir("MP_Data/C")),
             'd': len(os.listdir("MP_Data/D")),
             'e': len(os.listdir("MP_Data/E")),
             'f': len(os.listdir("MP_Data/F")),
             'g': len(os.listdir("MP_Data/G")),
             'h': len(os.listdir("MP_Data/H")),
             'i': len(os.listdir("MP_Data/I")),
             'j': len(os.listdir("MP_Data/J")),
             'k': len(os.listdir("MP_Data/K")),
             'l': len(os.listdir("MP_Data/L")),
             'm': len(os.listdir("MP_Data/M")),
             'n': len(os.listdir("MP_Data/N")),
             'o': len(os.listdir("MP_Data/O")),
             'p': len(os.listdir("MP_Data/P")),
             'q': len(os.listdir("MP_Data/Q")),
             'r': len(os.listdir("MP_Data/R")),
             's': len(os.listdir("MP_Data/S")),
             't': len(os.listdir("MP_Data/T")),
             'u': len(os.listdir("MP_Data/U")),
             'v': len(os.listdir("MP_Data/V")),
             'w': len(os.listdir("MP_Data/W")),
             'x': len(os.listdir("MP_Data/X")),
             'y': len(os.listdir("MP_Data/Y")),
             'z': len(os.listdir("MP_Data/Z"))
             }
